...
// Platform configs
const PLATFORMS = [
  { id: 'instagram', name: 'Instagram', features: ['Feed Posts', 'Reels', 'Stories', 'Carousels', 'First Comment'], authUrl: '/api/auth/instagram' },
  { id: 'tiktok', name: 'TikTok', features: ['Video Posts', 'Auto-publish'], authUrl: '/api/auth/tiktok' },
  { id: 'facebook', name: 'Facebook', features: ['Pages', 'Groups', 'Reels'], authUrl: '/api/auth/facebook', comingSoon: true },
  { id: 'twitter', name: 'X (Twitter)', features: ['Posts', 'Media', 'Threads'], authUrl: '/api/auth/twitter', comingSoon: true },
  { id: 'linkedin', name: 'LinkedIn', features: ['Personal', 'Company Pages'], authUrl: '/api/auth/linkedin', comingSoon: true },
  { id: 'youtube', name: 'YouTube', features: ['Video Uploads', 'Scheduled Publishing', 'Thumbnails'], authUrl: '/api/auth/youtube/connect' },
  { id: 'pinterest', name: 'Pinterest', features: ['Pins', 'Destination Links'], authUrl: '/api/auth/pinterest', comingSoon: true },
  { id: 'threads', name: 'Threads', features: ['Text + Media Posts'], authUrl: '/api/auth/threads', comingSoon: true },
];
...
function Connections() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-4 pb-6">
      ...
      <div className=" border border-dark-700/60 bg-dark-900/50 p-4 sm:p-5">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
          <div className="max-w-xl">
            <h2 className="text-sm font-medium text-dark-100">Clarosa</h2>
            ...
            <div className="mt-4 flex flex-wrap items-center gap-2 text-xs">
              ...
              <span className="border border-dark-700/60 bg-dark-950/50 px-3 py-1 text-dark-400">
          ...
          <div className="grid w-full gap-3 xl:max-w-xl">
            <div className=" border border-dark-700/60 bg-dark-950/45 p-4">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 border border-dark-700/60 bg-dark-950/55 px-4 py-2 text-sm text-dark-300 transition-colors hover:text-dark-100"
                  >
            ...
            {showClarosaAdvanced && (
              <div className="grid gap-3  border border-dark-700/60 bg-dark-950/45 p-4 sm:grid-cols-2">
                <label className="grid gap-2">
                  ...
                  <input
                    ...
                    className="h-11  border border-dark-700/60 bg-dark-950/70 px-4 text-sm text-dark-100 outline-none transition-colors placeholder:text-dark-500 focus:border-dark-500"
                  />
            ...
            {clarosaIndexSummary && (
              <div className=" border border-dark-700/60 bg-dark-950/45 px-4 py-3 text-sm text-dark-300">
      ...
      {currentProfile && (
        <div className=" border border-dark-700/60 bg-dark-900/50 p-4">
          <button
            onClick={() => setShowProfileConnections(!showProfileConnections)}
            className="w-full flex items-center justify-between  border border-dark-700/60 bg-dark-950/55 p-4 transition-colors hover:border-dark-600 hover:bg-dark-950/75"
          >
          ...
          {showProfileConnections && (
            <div className="mt-3 grid grid-cols-1 gap-2.5 md:grid-cols-2">
              ...
              <div className="border border-dark-700 bg-dark-800 p-3.5">
                <div>
                  <div className="flex-1 min-w-0">
                    ...
                    {loadingStatus ? (
                        ...
                        <div className="flex flex-wrap gap-2">
                          {profileSocialStatus.instagram.useParent ? (
                            <button
                              ...
                              className="inline-flex h-8 items-center border border-dark-700/60 bg-dark-950/55 px-3 text-xs text-dark-200 transition-colors hover:text-white"
                            ...
                            <button
                              ...
                              className="inline-flex h-8 items-center border border-dark-700/60 bg-dark-950/55 px-3 text-xs text-dark-300 transition-colors hover:text-dark-100"
                              disabled={connecting === 'instagram'}
                            >
                      ...
                      <>
                        ...
                        <button
                          onClick={() => handleUseParentConnection('instagram')}
                          className="inline-flex h-8 items-center gap-2 bg-dark-300 px-3 text-xs font-medium text-dark-900 transition-colors hover:bg-white"
                          disabled={connecting === 'instagram'}
                        >
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        {PLATFORMS.map((platform) => {
          ...
          return (
            <div
              key={platform.id}
              className={` border border-dark-700/60 bg-dark-900/45 p-4 transition-all ${
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mb-3 flex flex-wrap gap-1.5">
                    {platform.features.map((feature) => (
                      <span
                        key={feature}
                        className="border border-dark-700/50 bg-dark-950/55 px-2.5 py-1 text-[11px] text-dark-400"
                      >
                        {feature}
                      </span>
                    ))}
      ...
      {/* Help */}
      <div className="border border-dark-700 bg-dark-800 p-4">
        <p className="text-xs text-dark-400">
          Make sure you have admin access to the accounts you want to connect.
          For business accounts, you may need to configure API access in each platform's developer portal.
        </p>
      </div>
    </div>
  );
